  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end justify-center sm:items-center">
      ...
      <aside
        ...
        className="relative z-10 flex max-h-[88dvh] w-full max-w-lg flex-col rounded-t-[1.75rem] border-[3px] border-zinc-500 bg-[#121214] text-white shadow-2xl sm:mx-4 sm:rounded-[1.75rem]"
      >
          ...
          {items.length === 0 ? (
            ...
            <>
              {items.map((item) => (
                <div
                  key={item.productId}
                  className="flex gap-3 rounded-2xl border-[3px] border-zinc-500 bg-black/40 p-3"
                >
